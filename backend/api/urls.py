...
urlpatterns = [
    ...
    path('asaas/payments/', AsaasPaymentView.as_view(), name='asaas_payments_create'),
    path('asaas/payments/<str:payment_id>/', AsaasPaymentView.as_view(), name='asaas_payment_action'),
